              ...
              <div className="space-y-6">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="bg-surface border border-surface-high p-4 rounded-xl">
                    ...
                    <p className="text-lg font-medium text-primary capitalize">{result.strategyUsed?.replace('_', ' ') || result.strategy_used?.replace('_', ' ') || result.strategy?.replace('_', ' ') || result.data?.strategyUsed?.replace('_', ' ') || 'Auto-Evaluated'}</p>
                  </div>
                  <div className="bg-surface border border-surface-high p-4 rounded-xl">
